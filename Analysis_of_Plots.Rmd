---
title: "Analysis of Plots"
author: "Vinicio Alvarado"
date: "17/9/2020"
...
```{r Anonimous1, echo=FALSE, fig.cap="A caption", out.width = '50%'}
...
```{r Anonimous2, echo=FALSE, fig.cap="A caption", out.width = '50%'}
...
```{r Anonimous3, echo=FALSE, fig.cap="A caption", out.width = '50%'}
...
```{r Anonimous4, echo=FALSE, fig.cap="A caption", out.width = '50%'}
...
```{r Anonimous5, echo=FALSE, fig.cap="A caption", out.width = '50%'}
